...
export default function DomeGallery({
  ...
  maxRadius = Infinity,
  padFactor = 0.22,
  overlayBlurColor = "#1B1712",
  maxVerticalRotationDeg = 6,
  dragSensitivity = 20,
  enlargeTransitionMs = 320,
  segments = 25,
  dragDampening = 2,
  openedImageWidth = "min(420px, 84vw)",
  openedImageHeight = "min(420px, 84vw)",
            ...
            {items.map((it, i) => (
              ...
              >
                {it.src && (
                  ...
                  >
                    <img src={it.src} draggable={false} alt={it.alt} loading="eager" decoding="sync" />
                  </div>
                )}
              </div>
            ))}
